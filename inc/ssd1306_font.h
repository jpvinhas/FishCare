...
static uint8_t font[] = {
    ...
    // Glyph para '!' (índice 37)
    // Baseado no glcdfont padrão: {0x00, 0x00, 0x5F, 0x00, 0x00} expandido para 8 bytes.
    0x00, 0x00, 0x5F, 0x00, 0x00, 0x00, 0x00, 0x00,

    // Glyph para ':' (índice 38)
    // Padrão: {0x00, 0x36, 0x36, 0x00, 0x00} expandido para 8 bytes.
    0x00, 0x00, 0x36, 0x36, 0x00, 0x00, 0x00, 0x00,

     // Glyph para ')' (índice 39)
    // Usando o espelho do glifo para '(':
    // Para '(' na glcdfont: 0x00, 0x06, 0x09, 0x09, 0x09, 0x06, 0x00, 0x00
    // Então para ')': 0x00, 0x00, 0x60, 0x90, 0x90, 0x90, 0x60, 0x00
    0x00, 0x00, 0x60, 0x90, 0x90, 0x90, 0x60, 0x00,

    // Glyph para 'º' (índice 40)
    // Desenho 5x7 de um pequeno "o"
    0x00, 0x00, 0x36, 0x00, 0x00, 0x00, 0x00, 0x00,


    // Glyph para '-' (índice 41)
    // Um traço horizontal fino, com apenas a linha 3 acesa (0x08) em 3 colunas:
    0x00, 0x00, 0x08, 0x08, 0x08, 0x00, 0x00, 0x00,

    // Glyph para '.' (ponto final) (índice 42)
    // Um único ponto (por exemplo, acendendo o bit5 = 0x20)
